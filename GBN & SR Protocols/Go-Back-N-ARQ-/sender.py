    ...
    while i!=f:
        while(i!=(f-j)):
            ...
            if(b!="ACK Lost"):
                ...
                time.sleep(1)
                print("Acknowledgement of the data bit is LOST/NAK! The sliding window remains in the range "+(str(i+1))+" to "+str(k+1)+" Now Resending the same packet")
                time.sleep(1)
        while(i!=f):
            ...
            if(b!="ACK Lost"):
                ...
                time.sleep(1)
                print("Acknowledgement of the data bit is LOST!/NAK The sliding window remains in the range "+(str(i+1))+" to "+str(k)+" Now Resending the same packet")
                time.sleep(1)
